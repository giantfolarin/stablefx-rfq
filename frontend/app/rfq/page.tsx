    ...
    <div className="min-h-screen bg-[#0B0F14] py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="font-display text-[40px] font-bold text-[#E5E7EB] mb-4 tracking-tight">
            Institutional RFQ Trading
          </h1>
          <p className="text-[16px] text-[#9CA3AF] max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-[#111827] border border-[#1F2937] rounded-xl shadow-lg p-2 inline-flex">
            <button
              onClick={() => setViewMode('taker')}
              className={`px-6 py-3 rounded-lg font-semibold text-[13px] uppercase tracking-wide transition-all duration-150 ${
                viewMode === 'taker'
        ...
        {/* Features Banner */}
        <div className="mt-16 bg-[#111827] border border-[#1F2937] rounded-2xl p-8">
          <h3 className="font-display text-[24px] font-bold text-[#E5E7EB] mb-6 text-center tracking-tight">
            RFQ vs AMM Trading
          </h3>
        ...
        {/* How It Works */}
        <div className="mt-16 bg-[#161E2E] border border-[#374151] rounded-2xl p-8">
          <h3 className="font-display text-[24px] font-bold text-[#E5E7EB] mb-8 text-center tracking-tight">
            How RFQ Settlement Works
          </h3>
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-12 h-12 bg-[#3B82F6] rounded-full flex items-center justify-center text-[18px] font-bold mx-auto mb-3 text-white">
                1
              </div>
              <h4 className="font-bold text-[14px] text-[#E5E7EB] mb-2 tracking-tight">Maker Signs Quote</h4>
              <p className="text-[13px] text-[#9CA3AF] leading-relaxed">
                Market maker creates and signs quote using EIP-712
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[#34D399] rounded-full flex items-center justify-center text-[18px] font-bold mx-auto mb-3 text-white">
                2
              </div>
              <h4 className="font-bold text-[14px] text-[#E5E7EB] mb-2 tracking-tight">Taker Selects Quote</h4>
              <p className="text-[13px] text-[#9CA3AF] leading-relaxed">
                Taker compares quotes and selects best price
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[#93C5FD] rounded-full flex items-center justify-center text-[18px] font-bold mx-auto mb-3 text-white">
                3
              </div>
              <h4 className="font-bold text-[14px] text-[#E5E7EB] mb-2 tracking-tight">Onchain Verification</h4>
              <p className="text-[13px] text-[#9CA3AF] leading-relaxed">
                Contract verifies signature, nonce, and expiry
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[#FBBF24] rounded-full flex items-center justify-center text-[18px] font-bold mx-auto mb-3 text-white">
                4
              </div>
              <h4 className="font-bold text-[14px] text-[#E5E7EB] mb-2 tracking-tight">Atomic Settlement</h4>
              <p className="text-[13px] text-[#9CA3AF] leading-relaxed">
