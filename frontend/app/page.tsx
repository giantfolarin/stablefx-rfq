    ...
    <div className="min-h-screen">
      <section className="relative bg-gradient-to-br from-arc-500 via-arc-600 to-neon-purple overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24 sm:py-32">
          <div className="text-center">
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full text-white text-sm font-medium mb-8 border border-white/20">
              <span className="w-2 h-2 bg-fx-400 rounded-full animate-pulse"></span>
              <span>Powered by Circle Arc L1 • CCTP Native Settlement</span>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-24">
        <div className="text-center mb-16">
          <h2 className="font-display text-4xl font-bold text-slate-950 mb-4">
        ...
        <div className="bg-gradient-to-r from-arc-600 via-neon-purple to-neon-aqua rounded-2xl p-8 text-white text-center shadow-glow">
          <h3 className="font-display text-2xl font-bold mb-2">Arc L1 Production Network</h3>
          <p className="text-blue-100 mb-6">
            Onchain settlement via Arc L1 • CCTP-native stablecoin infrastructure
          </p>
          <div className="flex flex-wrap justify-center gap-3 text-sm">
            <span className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full font-medium border border-white/30">USDC Gas</span>
            <span className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full font-medium border border-white/30">CCTP Native</span>
            <span className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full font-medium border border-white/30">Sub-second Finality</span>
            <span className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full font-medium border border-white/30">EVM Compatible</span>
          </div>
        </div>
      </section>
    </div>
